        ...
        <nav class="navbar navbar-light bg-light">
            ...
            <span class="chooseView">
                            <label class="radio-inline">
                                <a href="/ListRgMicroOrg" class="lien1">  Liste</a>
                            </label>
                            <label class="radio-inline">
                                </i> <a href="/SlideRgMicroOrg"  class="lien1"> SlideShow </a>
                            </label>
                            <label class="radio-inline">
                                 <a href="/ImageRgMicroOrg"  class="lien1">  Grandes images </a>
                            </label>
        </span>
        </nav>
    ...
    <c:if   test="${rg.type == 5}">
        ...
        <div id="rgListeElement">
            ...
            <div id="InstitutionDetail">
                <h1 id="InstitutionName"> <a href="page-info-micro-orga/<c:out value="${rg.id}"/>"> ${rg.nomscient}  </a> </h1>
                <h1 id="InstitutionName"> <a href="page-info-micro-orga/<c:out value="${rg.id}"/>"> ${rg.nom} </a> </h1>
                <br>
