    ...
    <c:if   test="${rg.type == 1}">
        ...
        <div id="rgListeElement">
            ...
            <div id="InstitutionDetail">
                <h1 id="InstitutionName"> <a href="page-info-forest/<c:out value="${rg.id}"/>"> ${rg.nomscient}  </a> </h1>
                <h1 id="InstitutionName"> <a href="page-info-forest/<c:out value="${rg.id}"/>"> ${rg.nom} </a> </h1>
                <br>
