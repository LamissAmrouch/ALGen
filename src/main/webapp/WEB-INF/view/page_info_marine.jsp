        ...
        <section id="generalInfo" class="commun">
            <div id="generalInfoDive">
                <div id="textInfo1">
                    ...
                    <div style="display: flex">
                        <div>
                            <h1 id="rgInfoName">Distribution geographique </h1>
                            <p id="rgInfoDiscription">
                    ...
                    <br>
                    <div>
                        <h1 id="rgInfoName">Cle d'identification</h1>
                        <p id="rgInfoDiscription">
                            <c:out value="${rg.cle_identification}"/>
                        </p>
                    </div>
                ...
                <figure>
                    <img src="../img/<c:out value="${rg.lien_photo}"/>" class="rgInfoImg">
                </figure>
            </div>
            <!--***************************************************************************************************-->
            <div id="generalInfoDive2">
                ...
                <div>
                    ...
                    <p id="rgInfoDiscription">
                        <c:forEach items="${proc_traditionnels}" var="proc_traditionnel" varStatus="loop">
                            <c:if test="${rg.id == proc_traditionnel.getRg().id.toString()}">
                                <c:out value="${proc_traditionnel.getDescription()}"/>
                ...
                <div>
                    <h1 id="rgInfoName">Biotop </h1>
                    <p id="rgInfoDiscription">
                        <c:out value="${rg.biotope}"/>
                    </p>
                </div>
                ...
                <div>
                    <h1 id="rgInfoName">Niveau profondeur</h1>
                    <p id="rgInfoDiscription">
                        <!--<c:out value="${rg_plus.niveau_profondeur}"/>-->
                    </p>
                </div>
                <hr style="height:3px; background-color: #18d26e;">
                ...
                <div>
                    <h1 id="rgInfoName">Reproduction </h1>
                    <p id="rgInfoDiscription">
                        <c:out value="${rg.reproduction}"/>
                    </p>
                </div>
                <hr style="height:3px; background-color: #18d26e;">
        ...
        <c:choose>
            <c:when test="${logged}">
                ...
                <section style="display: flex;justify-content: center;flex-direction: column;align-items: center; ">
                    ...
                    <a href="/formulaire_Demande"><button class="button1" onclick="">Cliquer ici</button></a>
                    <br><br><br><br><br>
                </section>
                </c:if>
                </c:forEach>
