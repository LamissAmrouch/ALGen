...
<div class="cont">
    ...
    <form:form  method="post" action="/institution" modelAttribute="institution">
        <div class="modal-header">
            <h4 class="modal-title">Modifier une institution</h4>
        </div>
        ...
        <div class="form-group">
            ...
            <select id="typeInstitution" class="form-control" name="typeInstitution">
                <option value="NONE" disabled>Choisir le type de l'institution</option>
                <option value="Publique"  <c:if test="${institution.typeInstitution == 'Publique'}">selected</c:if> >Publique</option>
                <option value="Privé" <c:if test="${institution.typeInstitution == 'Privé'}">selected</c:if> >Privé</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <form:input path="image" type="text" id="image" value="" name="image" class="form-control" />
        </div>
        </div>
