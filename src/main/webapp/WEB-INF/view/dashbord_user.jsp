...
<div class="cont">
    ...
    <div class="table-title">
        <div class="row">
            ...
            <div class="col-sm-2">
                <a href="../user" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Ajouter</span></a>
            </div>
        </div>
    </div>
    <div>
        <form action="/search_user" method="post" class="modal-footer">
            ...
            <select class="form-control" name="roles" multiple="multiple">
                <option value="0" selected>Tous les rôles</option>
    ...
    <table class="table table-striped table-hover">
        ...
        <c:forEach items="${ users }" var="user" varStatus="status">
            <tr>
                <td scope="row"><c:out value="${ user.nom}"/></td>
                <td><c:out value="${ user.prenom}"/></td>
                <td><c:out value="${ user.email}"/></td>
                <td><c:out value="${ user.sex}"/></td>
                <td><c:out value="${ user.date_creation}"/></td>
                ...
                <td>
                    <a href="../updateuser/${user.id}" class="edit" ><i class="material-icons" title="Modifier">&#xE254;</i></a>
                    <a href="../deleteuser/${user.id}" class="delete"><i class="material-icons" title="Supprimer">&#xE872;</i></a>
